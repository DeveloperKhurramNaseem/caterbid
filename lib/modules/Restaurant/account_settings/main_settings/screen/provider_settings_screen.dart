...
import 'package:caterbid/modules/Restaurant/account_settings/main_settings/widget/provider_custom_appbar.dart';
import 'package:caterbid/modules/Restaurant/account_settings/main_settings/widget/provider_header_profile.dart';
import 'package:caterbid/modules/Restaurant/account_settings/main_settings/widget/provider_settings_list.dart';
import 'package:caterbid/modules/Restaurant/account_settings/main_settings/widget/provider_version_label.dart';
                ...
                builder: (context, state) {
                  if (state is ProviderProfileLoaded) {
                    return ProviderHeaderProfile(
                      name: state.user.companyName ?? 'Provider',
